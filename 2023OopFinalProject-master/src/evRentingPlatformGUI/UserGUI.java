...
public class UserGUI extends JFrame {
	...
	/**
	 * @param coupon user has available coupon 
	...
	public UserGUI(RentScooterService service) {
		...
		back.setBounds(1010, 739, 212, 62);
		ridepane.add(back);
		
		num.setFont(new Font("標楷體", Font.PLAIN, 30));
		num.setBounds(835, 40, 335, 52);
		ridepane.add(num);
		...
		hasCoupon.setBounds(738, 542, 175, 62);
		...
		withcoupon.setBounds(1000, 540, 157, 56);
