    ...
    public ScooterSelectionGUI(RentScooterService service,ArrayList<Scooter> scooterList,UserGUI frame1,double range) {
        ...
        selectButton.addActionListener(e -> {
            ...
            if (selectedRow != -1) {
                ...
                UserGUI.Mappanel=new JFXPanel();
                UserGUI.Mappanel.setBounds(539, 102, 837, 583);
        	    frame1.ridepane.add(UserGUI.Mappanel);
                UserGUI.initializeJavaFX();
                //
        		UserGUI.Mappanel=new JFXPanel();
        		UserGUI.Mappanel.setBounds(450, 73, 648, 487);
        		frame1.ridepane.add(UserGUI.Mappanel);
